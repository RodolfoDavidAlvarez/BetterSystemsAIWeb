...
export function registerRoutes(app: Express) {
  ...
  const INVOICE_PAYMENTS: Record<string, {
    ...
    "BSA-2026-006": {
      ...
      discountPaymentUrl: "https://invoice.stripe.com/i/acct_1OBpTYLe9qCZBeeN/live_YWNjdF8xT0JwVFlMZTlxQ1pCZWVOLF9VTGNVbEdWY3I1V3dHOUJuSXpFQ0dKYkg4ckdkUHh3LDE2NjkwNzIzNg020065WhsLHF?s=ap",
      fullPaymentUrl: "https://invoice.stripe.com/i/acct_1OBpTYLe9qCZBeeN/live_YWNjdF8xT0JwVFlMZTlxQ1pCZWVOLF9VTGNVbEdWY3I1V3dHOUJuSXpFQ0dKYkg4ckdkUHh3LDE2NjkwNzIzNg020065WhsLHF?s=ap",
      lineItems: [
