...
const INVOICE_PAYMENTS = {
  ...
  "BSA-2026-006": {
    ...
    discountPaymentUrl: "https://invoice.stripe.com/i/acct_1OBpTYLe9qCZBeeN/live_YWNjdF8xT0JwVFlMZTlxQ1pCZWVOLF9VTE5tWko3b1BpOG8xUTlGbGl6SERoTVdHZWxGZjVFLDE2Njg1MjUxNQ0200zv1shltd?s=ap",
    fullPaymentUrl: "https://invoice.stripe.com/i/acct_1OBpTYLe9qCZBeeN/live_YWNjdF8xT0JwVFlMZTlxQ1pCZWVOLF9VTE5tWko3b1BpOG8xUTlGbGl6SERoTVdHZWxGZjVFLDE2Njg1MjUxNQ0200zv1shltd?s=ap",
    lineItems: [
      { description: "2.1.1 — Rebrand to Mitch's Map", detail: "Logo, royal blue scheme, REALTOR header, stacked brokerage, splash screen, favicon, app icons, SEO meta tags", amount: 400.00 },
      { description: "2.1.2 — Legal & Compliance", detail: "Footer security bar, Terms & Conditions page, Privacy Policy, SMS/TCPA Policy, Equal Housing Opportunity page", amount: 400.00 },
      { description: "2.1.3 — Contact Form Redesign", detail: "Pill-button questions, SMS consent checkbox, compact no-scroll layout, lead notification emails", amount: 250.00 },
      { description: "2.1.4 — Mobile Optimization", detail: "Footer/control layering, safe areas, iPhone notch support, multi-device QA", amount: 150.00 },
      { description: "2.2.1 — Marker Clustering", detail: "Grouped pins with branded icons, expand on zoom, click to break apart", amount: 200.00 },
      { description: "2.2.2 — Smart Zoom Navigation", detail: "Auto-switch community/builder views, tuned thresholds, removed old back button", amount: 200.00 },
      { description: "2.2.3 — Builder Detail View Redesign", detail: "No-scroll sheet, model pill switching with video + stats, amenity overlay", amount: 300.00 },
      { description: "2.2.4 — Amenity Filter", detail: "7 types (Pool, Gym, Park, Trail, Tennis, Pickleball, Community Center), badge count, builder matching", amount: 200.00 },
      { description: "2.2.5 — Community Flag Markers", detail: "Flag design with community name, builder count, price range on satellite view", amount: 75.00 },
      { description: "2.2.6 — Community Name Label & Amenity Pins", detail: "Location indicator, text-only amenity pills", amount: 50.00 },
      { description: "2.3.1 — Builder Compliance & Disclosures", detail: "Homes built by [Builder], Buyer representation available, Brian Mitchell REALTOR text", amount: 75.00 },
      { description: "2.3.2 — Post-Walkthrough Fixes", detail: "Header/footer color match, button overlap, brokerage stacking, link fixes, walkthrough meeting", amount: 50.00 },
    ],
  },
};
